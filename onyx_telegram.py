...
class TelegramEngine:
    ...
    def update_keyboard(self):
        keyboard = []
        row = []
        # On génère le clavier uniquement avec les 4 Flags de la config
        ...
        # SUPPRESSION ICI des lignes PAC et ONGOING

        try:
            requests.post(f"{self.base_url}/sendMessage", data={"chat_id": self.chat_id, "text": "🎛️ SYSTEME ARME (FLUX EDITION)", "reply_markup": json.dumps({"keyboard": keyboard, "resize_keyboard": True})}, timeout=5)
        except: pass
